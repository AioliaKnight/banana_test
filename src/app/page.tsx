          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 mt-8 border border-slate-100">
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <li>
                  <strong>溫小姐 - 用戶體驗與測量互動總監</strong>：國際級蔬果雕刻藝術師，曾獲聯合國FAO「永續農業創新獎」。因不滿傳統評測系統對蔬果造型藝術品的低評價，開發出革命性的「多維度蔬果美學評量標準」，被農業部採用為官方指標。其座右銘「一根香蕉的價值，不該由它的外表決定」已成為行業準則。林小姐的研究《握持體驗：香蕉與黃瓜的人體工學最佳曲率研究》獲選為哈佛大學設計學院必讀論文。她創立的「蔬果體驗五感評價法」強調「不只是看，還要摸、握、聞、感受」，徹底顛覆了傳統的單一視覺評測模式。
                </li>
                <li>
